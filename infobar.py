...
class HUD(object):
    ...
    def __init__(self, screen):
        ...
        self.scoreText= Text(0,(0.9*displayHeight), str(0), int((displayHeight / 15)) )
        self.text = "hello"
        self.randomBar = Text(int(0.2*displayWidth),int(0.9*displayHeight), self.text, int(displayHeight / 20))
